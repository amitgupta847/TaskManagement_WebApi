...
namespace TaskManagement.Web.Api
{
    public class BasicSecurityService : IBasicSecurityService
    {
        ...
        //private IAllTasksInquiryProcessor _alltaskQueryProcessor; //
        public BasicSecurityService(ILogManager logManager)
        {
           // _alltaskQueryProcessor = alltaskQueryProcessor;
            _log = logManager.GetLog(typeof(BasicSecurityService));
        }

        public virtual IAllTasksInquiryProcessor _alltaskQueryProcessor
        {
            get { return WebContainerManager.Get<IAllTasksInquiryProcessor>(); }
        }
        ...
        public virtual User GetUser(string username)
        {
            ...
            return _alltaskQueryProcessor.GetUser(username);
        }
    }
}