    ...
    public class PagedDataRequestFactory : IPagedDataRequestFactory
    {
        ...
        public PagedDataRequest Create(Uri requestUri)
        {
            ...
            try
            {
                ...
                pageNumber =
                    PrimitiveTypeParser.Parse<int?>(valueCollection[CommonParameterNames.PageNumber]);
                pageSize = PrimitiveTypeParser.Parse<int?>(valueCollection[CommonParameterNames.PageSize]);
            }
            catch (Exception e)
            {
